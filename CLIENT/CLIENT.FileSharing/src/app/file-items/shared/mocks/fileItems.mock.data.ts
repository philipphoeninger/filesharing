...
export let MOCK_FILE_ITEMS: FileItem[] = [
  new FileItem(1, 'Music', new Date(2023, 11 - 1, 11, 13, 50, 23), true),
  new FileItem(2, 'Pictures', new Date(2023, 10 - 1, 21, 13, 50, 23), true),
  new FileItem(3, 'Mobile Data', new Date(2023, 10 - 1, 1, 13, 50, 23), true),
  new FileItem(
    4,
    'vacation_notes.txt',
